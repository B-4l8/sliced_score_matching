...
def parse_args_and_config():
    ...
    parser.add_argument('--config', type=str, default='dkef_perf/seizure.yml', help='Path to the config file')
    parser.add_argument('--seed', type=int, default=1234, help='Random seed')
    parser.add_argument('--run', type=str, default='run', help='Path for saving running related data.')
    parser.add_argument('--doc', type=str, default='seizure_gen', help='A string for documentation purpose')
...
def main():
    ...
    logging.info("Starting Seizure Data Generation Task...")
    ...
    try:
        ...
        output_csv = os.path.join(args.run, 'results', args.doc, 'generated_seizure_pos.csv')

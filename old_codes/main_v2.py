...
def parse_args_and_config():
    ...
    parser.add_argument('--config', type=str, default='dkef_perf/credit_card.yml', help='Path to the config file')
    parser.add_argument('--seed', type=int, default=1234, help='Random seed')
    parser.add_argument('--run', type=str, default='run', help='Path for saving running related data.')
    parser.add_argument('--doc', type=str, default='credit_card_gen', help='A string for documentation purpose')
...
def main():
    ...
    logging.info("Starting Credit Card Generation Task...")
    ...
    try:
        ...
        output_csv = os.path.join(args.run, 'results', args.doc, 'generated_creditcard_pos.csv')

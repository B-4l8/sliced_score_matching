...
def parse_args_and_config():
    ...
    parser.add_argument('--config', type=str, default='dkef_perf/synthetic_500.yml', help='Path to the config file')
    parser.add_argument('--seed', type=int, default=1234, help='Random seed')
    parser.add_argument('--run', type=str, default='run', help='Path for saving running related data.')
    parser.add_argument('--doc', type=str, default='synthetic_500_gen', help='A string for documentation purpose')
...
def main():
    ...
    logging.info("Starting Synthetic 500D Data Generation Task...")
    ...
    try:
        ...
        if os.path.exists(output_npy):
            ...
            header = ",".join([f'feat_{i}' for i in range(data.shape[1])])
